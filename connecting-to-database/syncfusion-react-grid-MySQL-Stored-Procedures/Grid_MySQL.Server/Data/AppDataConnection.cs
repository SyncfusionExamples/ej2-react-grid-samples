...
{
    // Holds the paged rows and the total matching count returned by GetTransactions 
    ...
    public sealed class AppDataConnection : DataConnection
    {
        ...
        // Calls GetTransactions with all data-action parameters so that sorting, filtering, 
            ...
            int take)
        {
            ...
            // GetTransactions returns one result set (the paged rows) and
        ...
        // Calls InsertTransaction, captures the OUT parameter p_NewId, and returns the newly generated auto-increment Id.
        ...
        // Calls UpdateTransaction for the given transaction row. Returns the number of rows affected (0 = not found, 1 = updated).
        public async Task<int> SpUpdateTransactionAsync(Transaction t)
        {
            // UpdateTransaction returns a single-row result set containing
        ...
        // Calls DeleteTransaction for the given primary key. Returns the number of rows deleted (0 = not found, 1 = deleted).
    ...
    // UpdateTransaction and DeleteTransaction return.
