...
2. **Copy the GitHub URL**
    ...
    - Example : https://github.com/SyncfusionExamples/ej2-react-grid-samples/tree/1010354-AddApolloGraphQLSample/connecting-to-database/syncfusion-react-grid-MySQL
