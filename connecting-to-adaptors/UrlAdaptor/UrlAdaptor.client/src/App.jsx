...
function App() {
    ...
    const data = new DataManager({
        url: 'http://localhost:5123/api/data',  // Replace 7007 with the backend port.
        insertUrl: 'http://localhost:5123/api/data/Insert',
        updateUrl: 'http://localhost:5123/api/data/Update',
        removeUrl: 'http://localhost:5123/api/data/Remove',
