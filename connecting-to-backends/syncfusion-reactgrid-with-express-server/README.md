...
2. **Copy the GitHub URL**
    ...
    - Example : https://github.com/SyncfusionExamples/ej2-react-grid-samples/tree/Ej2-EditReadmeFiles/connecting-to-backends/syncfusion-reactgrid-with-express-server
